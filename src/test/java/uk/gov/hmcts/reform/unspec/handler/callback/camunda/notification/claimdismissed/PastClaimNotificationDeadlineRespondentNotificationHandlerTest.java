...
@SpringBootTest(classes = {
    PastClaimNotificationDeadlineRespondentNotificationHandler.class,
    NotificationsProperties.class,
    JacksonAutoConfiguration.class
})
class PastClaimNotificationDeadlineRespondentNotificationHandlerTest {
    ...
    @Autowired
    private PastClaimNotificationDeadlineRespondentNotificationHandler handler;
    ...
    class AboutToSubmitCallback {
        ...
        @BeforeEach
        void setup() {
            when(notificationsProperties.getRespondentSolicitorClaimDismissedPastClaimNotificationDeadline())
