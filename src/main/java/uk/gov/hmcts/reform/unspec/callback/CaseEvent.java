...
public enum CaseEvent {
    ...
    NOTIFY_APPLICANT_SOLICITOR1_FOR_CASE_HANDED_OFFLINE_CC(CAMUNDA),
    ...
    NOTIFY_APPLICANT_SOLICITOR1_PAST_CLAIM_DISMISSED_DEADLINE(CAMUNDA),
    NOTIFY_RESPONDENT_SOLICITOR_PAST_CLAIM_DISMISSED_DEADLINE(CAMUNDA),
    NOTIFY_RESPONDENT_SOLICITOR1_PAST_CLAIM_NOTIFICATION_DEADLINE(CAMUNDA),
    NOTIFY_APPLICANT_SOLICITOR1_PAST_CLAIM_NOTIFICATION_DEADLINE(CAMUNDA),
    NOTIFY_APPLICANT_SOLICITOR1_PAST_CLAIM_DETAILS_NOTIFICATION_DEADLINE(CAMUNDA),
    NOTIFY_RESPONDENT_SOLICITOR1_PAST_CLAIM_DETAILS_NOTIFICATION_DEADLINE(CAMUNDA),
